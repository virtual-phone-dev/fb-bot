...
async def main():
    print("🚀 Bot démarre 112")
    
    commented_posts = load_commented_posts()
    print("passé commented_posts")

    async with async_playwright() as p:
    
        print("Lancement du browser")
...
@app.get("/")
async def read_root():
    return {"message": "Bot en cours d'exécution"}
    
   
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("r-congo:app", host="0.0.0.0", port=8000)
